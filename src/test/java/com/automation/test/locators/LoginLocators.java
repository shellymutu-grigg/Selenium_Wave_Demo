...
public class LoginLocators {
    ...
    public final static String KEEP_SIGNED_IN_ID="name:rememberMe";
    ...
    public final static String LOGIN_FAIL_IMPORTANT_MESSAGE_ID = "id:auth-warning-message-box";
    public final static String SIGN_IN_ID= "name:signIn";
